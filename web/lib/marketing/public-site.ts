...
export const AGENT_TEMPLATES: ReadonlyArray<AgentTemplate> = [
	{
		...
		description: "Reviews diffs, flags regressions, and leaves precise next steps.",
		longDescription:
	...
	},
	{
		...
		category: "Engineering",
		description: "Implements scoped changes with terminal access and saved artifacts.",
		longDescription:
	...
	},
	{
		...
		category: "Research",
		description: "Turns source gathering into a cited brief you can inspect.",
		longDescription:
	...
	},
	{
		...
		category: "Data",
		description: "Asks connected data tools questions and returns inspectable analysis.",
		longDescription:
	...
	},
	{
		...
		category: "Browser",
		description: "Uses browser and desktop-style tools inside the worker boundary.",
		longDescription:
	...
	},
	{
		...
		category: "Operations",
		description: "Triages tickets, drafts replies, and routes work that needs humans.",
		longDescription:
