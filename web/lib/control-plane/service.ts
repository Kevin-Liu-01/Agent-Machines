...
import { HostedWorkerRuntimeDriver, type HostedRuntimeExecutionOptions } from "./hosted-driver";
...
export function createHostedControlPlane(
	...
	executionOptions: HostedRuntimeExecutionOptions = {},
): AgentMachinesControlPlane {
	return new AgentMachinesControlPlane(
		createHostedControlPlaneStore(userId),
		new HostedWorkerRuntimeDriver(userId, initialConfig, executionOptions),
		{
