	...
	return {
		...
		"@graph": [
			...
			},
			{
				...
				featureList: [
					"MIT-licensed runtime and provider adapters with inspectable source",
					"Configurable agent setups and remote workspaces",
					"Runtime-specific model paths; hosted and direct SDK compatibility differ",
					...
					"Saved setup records and provider-backed workspace files",
					"Canonical memory documents under the sandbox user's ~/.agent-machines directory",
					"Hermes, OpenClaw, Claude Code, and Codex agent runtimes",
					"Daytona, E2B Sandbox, Sprites.dev, and Vercel Sandbox providers",
					...
					`${HARNESS.cliCount}+ CLI catalog entries; installation and authentication required`,
					`${HARNESS.nativeToolMin}–${HARNESS.nativeToolMax} agent-native tools depending on runtime`,
					"Starting configurations and editable Memory documents with Markdown export",
					...
					"Provider-specific lifecycle, snapshots, and filesystem migration",
				],
				about: [
