...
const MENU_GROUPS: ReadonlyArray<MenuGroup> = [
	...
	},
	{
		...
		body:
			"Choose a useful specialist or assemble one. The Worker keeps its identity, responsibility, memory, schedules, files, and evidence while the machinery changes.",
		cta: "Browse workers",
		ctaHref: "/agents",
